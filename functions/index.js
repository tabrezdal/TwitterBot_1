...
const twitterClient = new TwitterApi({
  clientId: 'c3JHS1M0djRwaG5sUHJXZjA5bWM6MTpjaQ',
  clientSecret: 'N4grghv8vOGdEoHcsRHNyMxyfByhFWhU_e4Q3SxqC1NEfuF4lV',
});

const callbackURL = 'http://127.0.0.1:5000/teztweetbot/us-central1/callback';
...
exports.callback = functions.https.onRequest((request, response) => {
  ...
  exports.tweet = functions.https.onRequest((request, response) => {
    ...
    const { data } = refreshedClient.v2.tweet(
      "Hello Everyone, Need FREE NFT Follow Us on Twitter, Join Discord Server and Claim your free TEZ Tiger NFT!"
